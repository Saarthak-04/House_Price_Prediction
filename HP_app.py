...
with open(r'C:\Users\Acer\Desktop\JN\House Price Prediction\House_prediction_model.pkl', 'rb') as file:
    model = pk.load(file)

st.header('House Price Predictor')
df = pd.read_csv(r'C:\Users\Acer\Desktop\JN\House Price Prediction\Cleaned_dataset.csv')
